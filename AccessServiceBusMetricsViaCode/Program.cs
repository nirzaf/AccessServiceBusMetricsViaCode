...
namespace AccessServiceBusMetricsViaCode
{
    class Program
    {
        ...
        static async Task RunSampleAsync()
        {
            ...
            MonitorManagementClient monitoringClient = new(serviceCreds)
            {
                BaseUri = null,
                SubscriptionId = null,
                AcceptLanguage = null,
                LongRunningOperationRetryTimeout = null,
                GenerateClientRequestId = null
            };           
            ...
            ODataQuery<MetadataValue> odataFilterMetrics = new($"EntityName eq '{entityName}'");
            ...
            Response metrics1 = await monitoringClient.Metrics.ListAsync(resourceUri: resourceId, metricnames: metricName, odataQuery: odataFilterMetrics, timespan: timeSpan, aggregation: aggregation, interval: TimeSpan.FromMinutes(1));
            Console.WriteLine(JsonConvert.SerializeObject(metrics1, Formatting.Indented));
